...
b榜單7 <- unlist(lapply(seo_tse07 ,function(x){grep(x,b_cwcsr07,value = F)}))
b榜單8 <- unlist(lapply(seo_tse08 ,function(x){grep(x,b_cwcsr08,value = F)}))
b榜單9 <- unlist(lapply(seo_tse09 ,function(x){grep(x,b_cwcsr09,value = F)}))
b榜單10 <- unlist(lapply(seo_tse10 ,function(x){grep(x,b_cwcsr10,value = F)}))
b榜單11 <- unlist(lapply(seo_tse11 ,function(x){grep(x,b_cwcsr11,value = F)}))
b榜單12 <- unlist(lapply(seo_tse12 ,function(x){grep(x,b_cwcsr12,value = F)}))
b榜單13 <- unlist(lapply(seo_tse13 ,function(x){grep(x,b_cwcsr13,value = F)}))
b榜單14 <- unlist(lapply(seo_tse14 ,function(x){grep(x,b_cwcsr14,value = F)}))
b榜單15 <- unlist(lapply(seo_tse15 ,function(x){grep(x,b_cwcsr15,value = F)}))
b榜單16 <- unlist(lapply(seo_tse16 ,function(x){grep(x,b_cwcsr16,value = F)}))
b榜單17 <- unlist(lapply(seo_tse17 ,function(x){grep(x,b_cwcsr17,value = F)}))
b榜單18 <- unlist(lapply(seo_tse18 ,function(x){grep(x,b_cwcsr18,value = F)}))
